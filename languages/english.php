...
$language['errors']['server_not_found']					= "Crew was not found";
...
$language['errors']['address_incorrect']				= "Your entered address is incorrect !";
$language['errors']['address_already_exists']			= "This address already exists in our database !";
...
$language['server']['tab_players']						= "Players";
...
$language['server']['general_address']					= "Address";
$language['server']['general_category']					= "Category";
$language['server']['general_owner']					= "Server Owner";
$language['server']['general_votes']					= "Votes";
$language['server']['general_hits']						= "Hits";
$language['server']['general_hits_month']				= "Hits this month";
...
$language['menu']['design_settings']	 				= "Layout";
...
$language['menu']['users_management']	 				= "User Management";
$language['menu']['categories_management']				= "Category Management";
$language['menu']['reports_management']					= "Reports Management";
$language['menu']['servers_management']					= "Crews Management";
$language['menu']['website_settings']					= "Website Settings";
$language['menu']['website_statistics']					= "Statistics";
$language['menu']['payments_management']				= "Payment Management";
...
$language['messages']['loggedin']	  	 				= "You are now logged in !";
$language['messages']['loggedout']	     				= "You are now logged out !";
$language['messages']['settings_updated']				= "Your settings have been updated !";
$language['messages']['success']		 				= "Your request was executed successfully !";
...
$language['messages']['server_added']					= "The server was added as <strong>private</strong> until you add the additional details.";
...
$language['misc']['order_by_hits']						= "Hits";
$language['misc']['order_by_latest']					= "Latest";
$language['misc']['reset_filters']						= "Reset Filters";
$language['misc']['filter_highlight']					= "Filter Highlighted";
$language['misc']['filter_status']						= "Filter Status";
$language['misc']['filter_country']						= "Filter Country";
$language['misc']['filter_version']						= "Filter Version";
...
$language['misc']['my_servers_status']					= "My crews status";
...
$language['misc']['servers_statistics']					= "Crews Statistics";
...
$language['misc']['statistics_servers']					= "Crews:";
...
$language['misc']['new_servers_today']					= "New Crews Today:";
$language['misc']['active_servers']						= "Active Crews:";
$language['misc']['private_servers']					= "Private Crews:";
$language['misc']['language']							= "<strong>Language:</strong>";
$language['misc']['index_description']					= "Find a crew to play with!";
$language['misc']['index_description2']					= "Or add your own crew to the list.";
...
$language['forms']['help_avatar']		 				= "Only JPG, JPEG formats are allowed !";
...
$language['forms']['settings_out_ads']					= "Out Ads Code ( leaving page top bar ads )";
...
$language['forms']['server_address']					= "Website Address";
...
$language['titles']['servers']							= "Crews";
$language['titles']['my_servers']						= "My Crews";
$language['titles']['my_favorites']						= "My Favorites";
$language['titles']['reports_management']				= "Report Management";
$language['titles']['view_report']						= "View report";
$language['titles']['edit_server']						= "Edit Crew";
$language['titles']['servers_management']				= "Servers Management";
$language['titles']['website_statistics']				= "Statistics";
$language['titles']['submit']							= "Submit Crew";
$language['titles']['purchase_highlight']				= "Purchase Highlight";
?>