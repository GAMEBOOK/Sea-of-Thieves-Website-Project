...
$result = $database->query("SELECT `server_id`, `category_id`, `address`, `date_added`, `private`, `active`, `highlight` FROM `servers` ORDER BY `server_id` DESC LIMIT {$_POST['limit']}, {$results_limit}");
...
<tr>
	...
	<td><a href="admin/edit-server/<?php echo $servers_data->server_id; ?>">Edit Server</a></td>
</tr>
<?php } ?>
