...
if(!empty($_POST)) {
	...
	if(empty($_SESSION['error'])) {
		...
		$stmt = $database->prepare("UPDATE `servers` SET `name` = ?, `category_id` = ?, `country_code` = ?, `youtube_id` = ?,  `description` = ? WHERE `server_id` = {$server->data->server_id}");
		$stmt->bind_param('sssss', $name, $category_id, $country_code, $youtube_id, $description);
		$stmt->execute();
...
<form action="" method="post" role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" value="<?php echo $server->data->address; ?>" disabled="disabled" />
	</div>
