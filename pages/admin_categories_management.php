...
<h3><?php echo $language['forms']['admin_add_category_header']; ?></h3>
...
<form action="" method="post" role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label><?php echo $language['forms']['admin_add_category_image']; ?></label>
		<p class="help-block"><?php echo $language['forms']['admin_add_category_image_help']; ?></p>
